...
// ResourcePermissionCmd Gets Permissions for Cipherguard Resource
var ResourcePermissionCmd = &cobra.Command{
	Use:     "permission",
	Short:   "Gets Permissions for a Cipherguard Resource",
	Long:    `Gets Permissions for a Cipherguard Resource`,
