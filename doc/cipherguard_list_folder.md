doc/cipherguard_list_folder.md## cipherguard list folder

Lists Cipherguard Folders
...
```
  -c, --column stringArray   Columns to return, possible Columns:
                             ID, FolderParentID, Name, CreatedTimestamp, ModifiedTimestamp (default [ID,FolderParentID,Name])
  -f, --folder stringArray   Folders that are in this Folder
  -g, --group stringArray    Folders that are shared with group
  -h, --help                 help for folder
  -s, --search string        Folders that have this in the Name
```
