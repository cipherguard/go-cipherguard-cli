doc/cipherguard_update_resource.md## cipherguard update resource

Updates a Cipherguard Folder
...
```
cipherguard update resource [flags]
```
...
```
  -h, --help          help for resource
      --id string     id of Folder to Update
